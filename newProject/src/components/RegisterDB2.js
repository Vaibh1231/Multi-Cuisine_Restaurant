...
export const RegisterDB2 = (props) => {
  ...
  return (
    ...
    <div className='auth-form-container2' style={{display:"flex" ,textAlign:"center",padding: 20}}>
      {/* <form> */}
      <div>
        ...
        <input style={{width:500, height:"35px",borderRadius:10 , border:"none"}} value={firstname} name="firstname" onChange={(e) => setFirstName(e.target.value)} id="firstname" placeholder="First Name" />
        <br></br>
        <br></br>
        ...
        <input style={{height:"35px",width:500, borderRadius:10 , border:"none"}} value={email} onChange={(e) => setEmail(e.target.value)}type="email" placeholder="Enter Email" id="email" name="email" />
        <br></br>
        <br></br>
        ...
        <select style={{height:"35px",width:500, borderRadius:"10px" , border:"none"}} id="s1" onChange={(e)=> setRole(e.target.value)} >
