...
function OrderReceived() {
    ...
    let getAllorder = async()=>{
        const result = await axios.get("http://localhost:8080/user/getListOrderReceived");
    ...
    {
        axios.put(`http://localhost:8080/user/assignOrderToDB/${index}`, {
          })
    ...
    return (
                <div className="m-4">
                {
                    receivedOrder.length > 0 ? <div className="mt-4">
                                ...
                                receivedOrder.map((o)=>
                                {
                                    return (
                                        <tr key={o.id}>
                                            ...
                                            <td>
                                                <button onClick={()=>{assignToDb(o.id)}} className="btn btn-primary">Assign to DE</button>
                                            </td>
                                        </tr>
                                    )
                                })
                ...
                </div> : <h4 style={{marginLeft:100}}>No orders received</h4>
                }
